...
import com.wdy.module.common.request.SmsSendRequest;
...
public class SmsSendUtil {
     ...
     * @return
     */
    public static SmsSendResponse sendMessage(String receiveUser, String message) throws ServiceException {
     ...
     * @throws
     */
    private static String sendSmsByPost(String path, String postContent) throws ServiceException {
        ...
        try {
            ...
            if (httpRspCode == HttpURLConnection.HTTP_OK) {
                ...
                throw new ServiceException("短信下发失败");
            }
        } catch (Exception e) {
            throw new ServiceException("短信下发失败");
        }
